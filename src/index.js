...
for (var indice = 0; indice < arranjo.length; indice++) {
...
arranjo.forEach(function(valor, indice){
  console.log('Arranjo ForEach: ', valor, ' Indice ', indice);
});

//Função anônima
const percorreColunas = function(linha, indiceLinha){
  //escopo/contexto da função está entre as chaves
  linha.forEach(function(coluna, indiceColuna){
    console.log('Linha: ', indiceLinha, ' Coluna: ', indiceColuna);
  });
};
